...
class GraphAnalytics:
    ...
    def compute_communities_lpa(
        self, nodes: List[str], edges: List[Tuple[str, str, float]], max_iter: int = 20
    ) -> Dict[str, int]:
        """
        ...
        for _ in range(max_iter):
            ...
            for node in shuffled_nodes:
                ...
                for neighbor, weight in adj[node]:
                    ...
                    label_weights[neigh_label] = (
                        label_weights.get(neigh_label, 0.0) + weight
                    )
    ...
    def analyze_graph(self) -> Dict[str, Any]:
        ...
        node_details = {
            row[0]: {"name": row[1], "node_type": row[2]} for row in cursor.fetchall()
        }
